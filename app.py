...
def process_image(image_path):
    ...
    return result_image_name, posture_result
...
def index():
    if request.method == 'POST':
        ...
        if file:
            ...
            predict_image, posture_result = process_image(upload_path)
            return render_template('result.html', original_image=upload_path, predict_image=predict_image, posture_result=posture_result)
